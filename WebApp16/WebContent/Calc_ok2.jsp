...
<!-- ※ 속성 이름과 동일한 파라미터인 경우
        ...
        스크립트릿 부분을 주석처리 하더라도 괜찮다라는 뜻 -->

<!-- ob.su1 = xxx; -->
<jsp:setProperty property="su1" name="ob"/>
<!-- 
request 영역 안에 있는 property 중에 su1이라는 것을 찾는다(서블릿 컨테이너가)
1. request.getParameter() 처리 -> 매개변수를 전달하기 위한 데이터 수신 처리
2. Integer.parseInt() 처리 -> 매개변수를 전달하기 위한 형 변환 처리
3. ob.su1 -> ob.setSu1() 호출 처리
